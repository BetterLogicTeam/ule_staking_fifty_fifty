...
import { getWidthdrawlReport } from "../../store/actions/dailyYield";
import moment from "moment";
import { CustomTable } from "../../components/CustomTable";

export const WidthdrawlReport = () => {
  const widthdrawlReport = useSelector(
    (state) => state?.dailyYield?.widthdrawlReport
  );
  // console.log("widthdrawlReport",widthdrawlReport);
        ...
        <div class="grid grid-1">
          ...
          <CustomTable
            columns={[
              ...
              { title: "ULE Value", field: "tokenvalue" },
              { title: "Txn", field: "txn" },
