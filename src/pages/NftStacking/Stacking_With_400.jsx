...
import { ULE_NFT_100, ULE_NFT_100_ABI, ULE_NFT_400, ULE_NFT_400_ABI, ULE_NFT_Staking_100, Ule_NFT_Staking_100_ABI, ULE_NFT_Staking_400, Ule_NFT_Staking_400_ABI } from '../Utils/Contract_Address';

export default function Stacking_With_400() {
    ...
    const ULE_Stake = async () => {
      ...
      setLoadingTrans(false)
            ...
            const web3 = await window.web3;
            let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_400_ABI, ULE_NFT_400);
            let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_400_ABI, ULE_NFT_Staking_400);
    ...
    <>
     <div class="col-md 9 stak">
        <div className="col-md-7 stack-md">
          <h4 className="stack-h4">NFT Staking 400  </h4>
