...
import { ULE_NFT_100, ULE_NFT_10000, ULE_NFT_10000_ABI, ULE_NFT_100_ABI, ULE_NFT_Staking_100, ULE_NFT_Staking_10000, Ule_NFT_Staking_10000_ABI, Ule_NFT_Staking_100_ABI } from '../Utils/Contract_Address';

export default function Stacking_With_10000() {
        ...
        try {
            ...
            if (userInfo.EthAddress.toLowerCase() == acc.toLowerCase()) {
              ...
              setLoadingTrans(false)
                    ...
                    const web3 = await window.web3;
                    let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_10000_ABI, ULE_NFT_10000);
                    let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_10000_ABI, ULE_NFT_Staking_10000);
                    ...
                    let Api_Conditon = await axios.post("https://ulenftapis.ulenft.site/stakeNftCondition", {
                      ...
                      if (check_Nft_Balance == acc) {
                        ...
                        await Ule_100_ContractOf.methods.setApprovalForAll(ULE_NFT_Staking_10000, true).send({
                            from: acc
                        })
        ...
        <>
            <div class="col-md 9 stak">
                <div className="col-md-7 stack-md">
                    <h4 className="stack-h4">NFT Staking 10000  </h4>
            ...
            />
              ...
              /> */}
                            ...
                            <div class="dropdown ms-2 mt-2 ">
                                ...
                                <ul
                                    class="dropdown-menu btn_dropdownhere text-center  h-auto fs-3 text-white "
