...
import { ULE_NFT_100, ULE_NFT_100_ABI, ULE_NFT_300, ULE_NFT_300_ABI, ULE_NFT_Staking_100, Ule_NFT_Staking_100_ABI, ULE_NFT_Staking_300, Ule_NFT_Staking_300_ABI } from '../Utils/Contract_Address';

export default function Stacking_With_300() {
    ...
    try {
      ...
      if (userInfo.EthAddress.toLowerCase() == acc.toLowerCase()) {
        if (tokenid == "") {
          ...
          const web3 = await window.web3;
          let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_300_ABI, ULE_NFT_300);
          let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_300_ABI, ULE_NFT_Staking_300);
          ...
          if (check_Nft_Balance == acc) {
            ...
            await Ule_100_ContractOf.methods.setApprovalForAll(ULE_NFT_Staking_300, true).send({
              from: acc
            })
    ...
    <>
      <div class="col-md 9 stak">
        <div className="col-md-7 stack-md">
          <h4 className="stack-h4">NFT Staking 300  </h4>
