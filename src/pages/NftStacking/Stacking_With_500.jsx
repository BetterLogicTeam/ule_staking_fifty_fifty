...
import { ULE_NFT_100, ULE_NFT_100_ABI, ULE_NFT_500, ULE_NFT_500_ABI, ULE_NFT_Staking_100, Ule_NFT_Staking_100_ABI, ULE_NFT_Staking_500, Ule_NFT_Staking_500_ABI } from '../Utils/Contract_Address';

export default function Stacking_With_500() {
    ...
    try {
      ...
      if (userInfo.EthAddress.toLowerCase() == acc.toLowerCase()) {
        if (tokenid == "") {
          ...
          const web3 = await window.web3;
          let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_500_ABI, ULE_NFT_500);
          let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_500_ABI, ULE_NFT_Staking_500);
          ...
          if (check_Nft_Balance == acc) {
            ...
            await Ule_100_ContractOf.methods.setApprovalForAll(ULE_NFT_Staking_500, true).send({
              from: acc
            })
    ...
    <>
      <div class="col-md 9 stak">
        <div className="col-md-7 stack-md">
          <h4 className="stack-h4">NFT Staking 500  </h4>
