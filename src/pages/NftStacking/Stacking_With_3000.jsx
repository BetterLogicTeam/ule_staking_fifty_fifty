...
import { ULE_NFT_100, ULE_NFT_100_ABI, ULE_NFT_3000, ULE_NFT_3000_ABI, ULE_NFT_Staking_100, Ule_NFT_Staking_100_ABI, ULE_NFT_Staking_3000, Ule_NFT_Staking_3000_ABI } from '../Utils/Contract_Address';
      ...
      try {
        ...
        if (userInfo.EthAddress.toLowerCase() == acc.toLowerCase()) {
          if (tokenid == "") {
            ...
            const web3 = await window.web3;
            let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_3000_ABI, ULE_NFT_3000);
            let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_3000_ABI, ULE_NFT_Staking_3000);
            ...
            if (check_Nft_Balance == acc) {
              ...
              await Ule_100_ContractOf.methods.setApprovalForAll(ULE_NFT_Staking_3000, true).send({
                from: acc
              })
