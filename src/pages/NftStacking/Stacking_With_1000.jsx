...
import { ULE_NFT_100, ULE_NFT_1000, ULE_NFT_1000_ABI, ULE_NFT_100_ABI, ULE_NFT_Staking_100, ULE_NFT_Staking_1000, Ule_NFT_Staking_1000_ABI, Ule_NFT_Staking_100_ABI } from '../Utils/Contract_Address';

export default function Stacking_With_1000() {
    ...
    const ULE_Stake = async () => {
      ...
      try {
        ...
        setLoadingTrans(false)
            ...
            const web3 = await window.web3;
            let Ule_100_ContractOf = new web3.eth.Contract(ULE_NFT_1000_ABI, ULE_NFT_1000);
            let ULE_Staking_ContractOf = new web3.eth.Contract(Ule_NFT_Staking_1000_ABI, ULE_NFT_Staking_1000);
            ...
            if (check_Nft_Balance == acc) {
              ...
              await Ule_100_ContractOf.methods.setApprovalForAll(ULE_NFT_Staking_1000, true).send({
                from: acc
              })
    ...
    <>
     <div class="col-md 9 stak">
        <div className="col-md-7 stack-md">
          <h4 className="stack-h4">NFT Staking 1000  </h4>
