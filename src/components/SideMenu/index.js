      ...
      >
        ...
        <div className="wdg-links">
          ...
          {dashboard?.userId && (
            <div className="wdg-box bxset primary">
              <input
                ...
                id="myInput1"
                value={`http://www.yulenft.net/login?referrallink=${dashboard?.userId}`}
              />
          ...
          <div className="wdg-actions">
            <CopyToClipboard
              text={`http://www.yulenft.net/login?referrallink=${dashboard?.userId}`}
        ...
        <div className="wdg-links">
          ...
          <div className="wdg-box bxset primary">
            <a
              href={`https://bscscan.com/address/${dashboard?.walletAddress}`}
              target={"_blank"}
            >
              <input
                type="text"
                onClick={() =>
                  `window.open('https://bscscan.com/address/${dashboard?.walletAddress}','_blank')`
                }
